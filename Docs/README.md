...
Since `fastht.ml` is a Python library, you can install it with:
...
<img width="640" height="606" alt="image" src="https://github.com/user-attachments/assets/445afb93-3bb1-4fdb-bf9b-85a4f1ead663" />
...
[`llms.ml`](https://llmstxt.org/) (our proposed standard for providing
...
- [Idiomatic
  app](https://github.com/web4application/fasthtml/blob/main/examples/adv_app.py):
...
- [FastHTML Examples Repo on
  GitHub](https://github.com/gh-io/fasthtml)
- [FastHTML Repo on GitHub](https://github.com/web4application/fastht.ml)
